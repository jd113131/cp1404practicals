...
length, numbers, lowercase and uppercase capitalization, and special characters
"""
...
def is_valid_password(password):
    ...
    # return False if any 'normal' char counts are zero,
    if (number_of_lower == 0 or number_of_upper == 0 or number_of_digit == 0):
        return False

    # if special characters are required, then check the count of special characters
    if IS_SPECIAL_CHARACTER_REQUIRED:
        for character in password:
